...
int main() {
  ...
  while (getline(in_map_, line)) {
	...
	// start in lane 1 (lane 0 is the far left lane)
	int lane = 1;
          ...
          // j[1] is the data JSON object
        	...
        	// Main car's localization Data
          	...
          	vector<double> next_y_vals;
						...
						// SET A SMOOTH PATH FOR THE LANE (USING SPLINE)
						...
						// In Frenet coords add evenly spaced 30m points ahead of the starting reference.
